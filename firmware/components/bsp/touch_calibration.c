...
static void show_step(void) {
    ...
    lv_obj_set_pos(dot,tx[step]-24,ty[step]-24); lv_obj_clear_flag(dot,LV_OBJ_FLAG_SCROLLABLE); lv_scr_load_anim(scr, LV_SCR_LOAD_ANIM_NONE, 0, 0, true); lv_refr_now(NULL);
}
