...
"""
    ...
    def test_dual_rate_csv_basic(self):
        """Test loading a dual-rate CSV with I and G rows."""
...
"""
        f = io.StringIO(csv_data)
        loader = CSVLoader()
        session = loader.load(f, source_name="dual_rate_test.csv")
    ...
    def test_dual_rate_gps_interpolation(self):
...
"""
    ...
    def test_dual_rate_no_gps_rows(self):
        """Test dual-rate CSV with only IMU rows (no GPS fix yet)."""
        csv_data = """tick_ms,row_type,acc_x,acc_y,acc_z,gyro_x,gyro_y,gyro_z,lat,lon,alt,speed,sats,vbat
1000,I,0.10,0.20,1.00,1.0,2.0,3.0,,,,,,
1010,I,0.11,0.21,1.01,1.1,2.1,3.1,,,,,,
"""
