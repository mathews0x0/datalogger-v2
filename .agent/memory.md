...
1.  **Reasoning First**: Briefly state the reasoning behind each step before execution. Keep it concise but enough to allow the user to interrupt if the path is wrong.
...
7.  **Continuous Optimization**: Proactively suggest improvements to agent files or project structure to increase efficiency.
